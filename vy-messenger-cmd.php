...
try {
	...
	case 'setTheme':
	echo $messenger->setTheme($userid);
	break;
	...
	break;
	case 'get-groups-count':
	echo $messenger->getTotalGroupsCount();
	break;
	...
	echo $core->getTurnCredentials();
	break;
	case 'reqcall':
	$messenger->requestCall();
	break;
	case 'get-request-videochat-confirmation-dialog':
	$messenger->videochatDialogConfirmation();
	break;
	default:
