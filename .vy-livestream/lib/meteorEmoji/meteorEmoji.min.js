class MeteorEmoji {
  ...
  hideemoji() {
    ...
    const that = this;
    this.global_emoji.style.display = "none";

        const selRange = (el) => {
 
             let _Txt_area_length = $(el).val().length || $(el).text().length;
  ...
  generateElements(emojiInput) {
    ...
    emojiPicker.classList.add('vyelement-meteoremoji');
    ...
    this.global_emoji = emojiPicker;
    const _that = this;
    //window.addEventListener('click', function(e){   
    $(document).off('click.closeEmojiMeteor').on('click.closeEmojiMeteor', function(e){
      e.preventDefault();
