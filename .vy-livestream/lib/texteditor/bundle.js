...
var css = "@charset \"utf-8\";\n.vy_lv_prodaddtxteditorcnt .jumbotron {\n  background-color: #67a754;\n  background-image: url(images/radial_bg.png);\n  background-position: center center;\n  background-repeat: no-repeat;\n  background: -webkit-gradient(radial, center center, 0, center center, 460, from(#b3ecff), to(#7edeff));\n  /* Safari 4-5, Chrome 1-9 */\n  /* Can't specify a percentage size? Laaaaaame. */\n  background: -webkit-radial-gradient(circle, #b3ecff, #7edeff);\n  /* Safari 5.1+, Chrome 10+ */\n  background: -moz-radial-gradient(circle, #b3ecff, #7edeff);\n  /* Firefox 3.6+ */\n  background: -ms-radial-gradient(circle, #b3ecff, #7edeff);\n  /* IE 10 */\n  box-shadow: 0 3px 7px rgba(0, 0, 0, 0.2) inset, 0 -3px 7px rgba(0, 0, 0, 0.2) inset;\n  color: #fff;\n  padding: 40px 0;\n  position: relative;\n  text-shadow: 0 1px 3px rgba(255, 255, 255, 0.4), 0 0 30px rgba(255, 255, 255, 0.075);\n}\n.vy_lv_prodaddtxteditorcnt .jumbotron h1 {\n  font-family: 'Roboto', sans-serif !important;\n  font-size: 45px;\n  font-weight: 300;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.4);\n  padding-bottom: 20px;\n}\n.vy_lv_prodaddtxteditorcnt .jumbotron h1 span {\n  color: rgba(0, 0, 0, 0.4);\n}\n.vy_lv_prodaddtxteditorcnt .jumbotron p {\n  font-family: 'Roboto', sans-serif !important;\n  font-size: 30px;\n  font-weight: 300;\n  line-height: 1.25;\n  color: #444;\n}\n.vy_lv_prodaddtxteditorcnt .jumbotron .container {\n  position: relative;\n  z-index: 2;\n}\n.vy_lv_prodaddtxteditorcnt .jumbotron:after {\n  background: url(\"../images/pattern.png\") repeat scroll center center transparent;\n  bottom: 0;\n  content: \"\";\n  display: block;\n  left: 0;\n  opacity: 0.4;\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n.vy_lv_prodaddtxteditorcnt .jumbotron:after {\n  background-size: 400px 400px;\n}\n.vy_lv_prodaddtxteditorcnt .masthead {\n  color: #fff;\n  margin-bottom: 0;\n  padding: 30px 0 10px;\n}\n.vy_lv_prodaddtxteditorcnt h2.demo-text {\n  font-family: 'Roboto', sans-serif !important;\n  font-size: 45px;\n  font-weight: 300;\n  color: #51d2ff;\n  text-align: center;\n  margin: 20px 0;\n  line-height: 40px;\n}\n.vy_lv_prodaddtxteditorcnt .features {\n  padding: 20px 0 10px 0;\n  background: #eee;\n  font-family: 'Roboto', sans-serif !important;\n  font-size: 25px;\n  line-height: 35px;\n  text-align: center;\n  font-weight: 300;\n}\n.vy_lv_prodaddtxteditorcnt .footer {\n  border-top: 1px solid #ddd;\n  margin: 20px 0 10px 0;\n  padding-top: 10px;\n  font-size: 12px;\n}\n.vy_lv_prodaddtxteditorcnt .Editor-container {\n  margin-top: 10px;\n  font-family: Gotham, \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-menu-bar {\n  background-color: #f5f5f5;\n  *background-color: #e6e6e6;\n  background-image: -moz-linear-gradient(top, #fff, #e6e6e6);\n  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#fff), to(#e6e6e6));\n  background-image: -webkit-linear-gradient(top, #fff, #e6e6e6);\n  background-image: -o-linear-gradient(top, #fff, #e6e6e6);\n  background-image: linear-gradient(to bottom, #fff, #e6e6e6);\n  background-repeat: repeat-x;\n  border: 1px solid #ccc;\n  *border: 0;\n  border-color: #e6e6e6 #e6e6e6 #bfbfbf;\n  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);\n  border-bottom-color: #b3b3b3;\n  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffffff', endColorstr='#ffe6e6e6', GradientType=0);\n  filter: progid:DXImageTransform.Microsoft.gradient(enabled=false);\n  *zoom: 1;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-status-bar {\n  background-color: #f5f5f5;\n  *background-color: #e6e6e6;\n  background-image: -moz-linear-gradient(top, #fff, #e6e6e6);\n  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#fff), to(#e6e6e6));\n  background-image: -webkit-linear-gradient(top, #fff, #e6e6e6);\n  background-image: -o-linear-gradient(top, #fff, #e6e6e6);\n  background-image: linear-gradient(to bottom, #fff, #e6e6e6);\n  background-repeat: repeat-x;\n  border: 1px solid #ccc;\n  *border: 0;\n  border-color: #e6e6e6 #e6e6e6 #bfbfbf;\n  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);\n  border-bottom-color: #b3b3b3;\n  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffffff', endColorstr='#ffe6e6e6', GradientType=0);\n  filter: progid:DXImageTransform.Microsoft.gradient(enabled=false);\n  *zoom: 1;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-menu-bar {\n  border-radius: 3px 3px 0 0;\n  border-bottom: none;\n  min-height: 25px;\n  padding: 5px 0;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-menu-bar div:first-child {\n  margin-left: 3px;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-menu-bar .dropdown {\n  float: left;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-menu-bar .dropdown-toggle {\n  font-size: 14px;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-menu-bar .dropdown-toggle .caret {\n  margin-left: 5px;\n  border-top-color: #999;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-menu-bar a.btn {\n  position: relative;\n  margin-bottom: 3px;\n}\n.vy_lv_prodaddtxteditorcnt select,\n.vy_lv_prodaddtxteditorcnt textarea,\n.vy_lv_prodaddtxteditorcnt input[type=\"text\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"password\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"datetime\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"datetime-local\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"date\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"month\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"time\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"week\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"number\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"email\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"url\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"search\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"tel\"],\n.vy_lv_prodaddtxteditorcnt input[type=\"color\"],\n.vy_lv_prodaddtxteditorcnt .uneditable-input {\n  height: auto;\n  margin-bottom: 10px;\n}\n.vy_lv_prodaddtxteditorcnt .line-control-status-bar {\n  min-height: 30px;\n  border-radius: 0 0 3px 3px;\n  border-top: none;\n  line-height: 30px;\n  text-shadow: 0 1px 1px rgba(255, 255, 255, 0.75);\n}\n.vy_lv_prodaddtxteditorcnt .line-control-status-bar .label {\n  float: right;\n  margin: 6px 10px 0 0;\n  background: #bbb;\n  text-shadow: 0px -1px 0px rgba(0, 0, 0, 0.25);\n  padding: 2px 4px;\n  font-size: 11.844px;\n  line-height: 14px;\n}\n.vy_lv_prodaddtxteditorcnt .Editor-editor {\n  height: 300px;\n  padding: 1%;\n  border: 1px solid #eee;\n  border-radius: 0;\n  word-wrap: break-word;\n}\n.vy_lv_prodaddtxteditorcnt #paletteCntr ul {\n  width: 145px;\n  float: left;\n  z-index: 999;\n  margin: 0 10px;\n}\n.vy_lv_prodaddtxteditorcnt #paletteCntr li {\n  cursor: pointer;\n  display: block;\n  height: 16px;\n  float: left;\n  margin: 0;\n  padding: 0;\n  width: 16px;\n  margin: 1px;\n}\n.vy_lv_prodaddtxteditorcnt #paletteCntr li div {\n  text-align: left;\n  margin: 0;\n  font-size: 12px;\n}\n.vy_lv_prodaddtxteditorcnt div.activeColour {\n  position: absolute;\n  display: inline;\n  left: 0;\n  top: 30px;\n  background: #e8e8e8;\n  padding-bottom: 10px;\n  z-index: 10000;\n}\n.vy_lv_prodaddtxteditorcnt #colorpellete,\n.vy_lv_prodaddtxteditorcnt #bg_colorpellete {\n  float: left;\n}\n.vy_lv_prodaddtxteditorcnt .bg_activeColour {\n  position: absolute;\n  display: inline;\n  float: left;\n}\n.vy_lv_prodaddtxteditorcnt .specialCntr {\n  background-color: #e8e8e8 !important;\n  display: inline;\n  position: absolute;\n  width: 176px;\n  top: 30px;\n  left: 0;\n}\n.vy_lv_prodaddtxteditorcnt .specialCntr ul {\n  float: left;\n  margin: 10px;\n  white-space: normal;\n  -webkit-padding-start: 0px;\n  -moz-padding-start: 0px;\n}\n.vy_lv_prodaddtxteditorcnt .specialCntr ul li {\n  list-style: none;\n  float: left;\n  font-size: 12px;\n  width: 20px;\n  height: 20px;\n  background: #fff;\n  margin: 3px;\n  color: #333;\n  text-align: center;\n  font-weight: bold;\n  cursor: pointer;\n}\n.vy_lv_prodaddtxteditorcnt .specialCntr ul li:hover {\n  background: #666;\n  color: #fff;\n}\n.vy_lv_prodaddtxteditorcnt pre {\n  white-space: pre-wrap;\n  /* css-3 */\n  white-space: -moz-pre-wrap;\n  /* Mozilla, since 1999 */\n  white-space: -pre-wrap;\n  /* Opera 4-6 */\n  white-space: -o-pre-wrap;\n  /* Opera 7 */\n  word-wrap: break-word;\n  /* Internet Explorer 5.5+ */\n}\n.vy_lv_prodaddtxteditorcnt .on {\n  display: block;\n  position: relative;\n}\n.vy_lv_prodaddtxteditorcnt .fullscreen {\n  position: fixed;\n  background: #fff;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  z-index: 1000;\n  margin: 0;\n}\n.vy_lv_prodaddtxteditorcnt .fullscreen .line-control-status-bar {\n  position: fixed;\n  bottom: 0;\n  border-top: 1px solid #ddd;\n}\n.vy_lv_prodaddtxteditorcnt .fullscreen #contentarea {\n  border: none;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-below > .nav-tabs,\n.vy_lv_prodaddtxteditorcnt .tabs-right > .nav-tabs,\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs {\n  border-bottom: 0;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-left ul {\n  -webkit-padding-start: 0px;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs > li,\n.vy_lv_prodaddtxteditorcnt .tabs-right > .nav-tabs > li {\n  float: none;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs > li > a,\n.vy_lv_prodaddtxteditorcnt .tabs-right > .nav-tabs > li > a {\n  min-width: 74px;\n  margin-right: 0;\n  margin-bottom: 3px;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs {\n  float: left;\n  margin-right: 19px;\n  border-right: 1px solid #ddd;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs > li > a {\n  margin-right: -1px;\n  -webkit-border-radius: 4px 0 0 4px;\n  -moz-border-radius: 4px 0 0 4px;\n  border-radius: 4px 0 0 4px;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs > li > a:hover,\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs > li > a:focus {\n  border-color: #eee #ddd #eee #eee;\n  outline: none;\n}\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs .active > a,\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs .active > a:hover,\n.vy_lv_prodaddtxteditorcnt .tabs-left > .nav-tabs .active > a:focus {\n  border-color: #ddd transparent #ddd #ddd;\n  *border-right-color: #fff;\n  color: #00b0f5 !important;\n  outline: none;\n}\n@-moz-document url-prefix()  {\n  .vy_lv_prodaddtxteditorcnt .form-control {\n    padding: 6px 12px 10px 12px;\n  }\n}\n.vy_lv_prodaddtxteditorcnt .form-control-width {\n  width: 100px;\n}\n.vy_lv_prodaddtxteditorcnt .form-control-link {\n  width: 204px;\n  display: inline-block;\n  margin-bottom: 5px;\n  margin-right: 5px;\n}\n.vy_lv_prodaddtxteditorcnt .form-control-button-right {\n  width: 204px;\n}\n.vy_lv_prodaddtxteditorcnt .inline-form-control {\n  display: inline !important;\n}\n.vy_lv_prodaddtxteditorcnt .btn-group + .btn-group {\n  margin-left: 5px;\n}\n.vy_lv_prodaddtxteditorcnt .activeColour ul {\n  -webkit-padding-start: 0px;\n  -moz-padding-start: 0px;\n}\n.vy_lv_prodaddtxteditorcnt h1 {\n  margin-top: 10px;\n  line-height: 40px;\n}\n.vy_lv_prodaddtxteditorcnt .col-lg-6 nth:child(1) {\n  margin-left: 0px;\n}\n.vy_lv_prodaddtxteditorcnt .nopadding {\n  padding: 0px;\n}\n.vy_lv_prodaddtxteditorcnt .nopadding-right {\n  padding-right: 0px;\n}\n.vy_lv_prodaddtxteditorcnt .modal {\n  overflow-y: auto;\n}\n.vy_lv_prodaddtxteditorcnt .padding-top {\n  padding-top: 10px;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu {\n  position: relative;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu > .dropdown-menu {\n  top: 0;\n  left: 100%;\n  margin-top: -6px;\n  margin-left: -1px;\n  -webkit-border-radius: 0 6px 6px 6px;\n  -moz-border-radius: 0 6px 6px 6px;\n  border-radius: 0 6px 6px 6px;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu:hover > .dropdown-menu {\n  display: block;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu > a:after {\n  display: block;\n  content: \" \";\n  float: right;\n  width: 0;\n  height: 0;\n  border-color: transparent;\n  border-style: solid;\n  border-width: 5px 0 5px 5px;\n  border-left-color: #ccc;\n  margin-top: 5px;\n  margin-right: -10px;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu:hover > a:after {\n  border-left-color: #fff;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu.pull-left {\n  float: none;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu.pull-left > .dropdown-menu {\n  left: -100%;\n  margin-left: 10px;\n  -webkit-border-radius: 6px 0 6px 6px;\n  -moz-border-radius: 6px 0 6px 6px;\n  border-radius: 6px 0 6px 6px;\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-menu > li > a:hover,\n.vy_lv_prodaddtxteditorcnt .dropdown-menu > li > a:focus,\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu:hover > a,\n.vy_lv_prodaddtxteditorcnt .dropdown-submenu:focus > a {\n  color: #fff;\n  text-decoration: none;\n  background-color: #0081c2;\n  background-image: -moz-linear-gradient(top, #08c, #0077b3);\n  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#08c), to(#0077b3));\n  background-image: -webkit-linear-gradient(top, #08c, #0077b3);\n  background-image: -o-linear-gradient(top, #08c, #0077b3);\n  background-image: linear-gradient(to bottom, #08c, #0077b3);\n  background-repeat: repeat-x;\n  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff0088cc',endColorstr='#ff0077b3',GradientType=0);\n}\n.vy_lv_prodaddtxteditorcnt .dropdown-menu > li > a {\n  cursor: pointer;\n}\n"; (require("browserify-css").createStyle(css, { "href": "editor.css" }, { "insertAt": "bottom" })); module.exports = css;
	...
	var methods = {
		...
		init : function( options )
		{
			...
			var statusBar = $("<div/>", {	id : "statusbar_" + $(this).attr("id"),
	       	...
	       	//For contextmenu	       	
		    $(document.body).off('mousedown.texteditorcontextmenu').on('mousedown.texteditorcontextmenu',function(event) {
...
require("./editor.css");
require("./editor.js");
},{"./editor.css":1,"./editor.js":2}],4:[function(require,module,exports){
'use strict';
