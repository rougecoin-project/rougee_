jQuery(document).ready(function ($) {
  try {
      ...
      // Check if mediaDevices itself is defined; if not, initialize it.
      if (!navigator.mediaDevices) {
          navigator.mediaDevices = {};
      }

      // Check if getUserMedia is supported; if not, use the old prefixed versions.
