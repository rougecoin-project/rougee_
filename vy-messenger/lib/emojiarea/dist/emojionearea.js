...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
            ...
            if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        ...
                        emojione.emojiSize = _emojiDefaultSize;
    ...
    EmojioneArea.prototype.showPicker = function () {
        ...
        if(!$('body').find('.Menu42f').length){
             self.picker.append('<div class="Menu42f backdrop" id="vymsn_dom_removeemojioneareapicker"></div>').find('#vymsn_dom_removeemojioneareapicker').off('click').on('click',function(e){
